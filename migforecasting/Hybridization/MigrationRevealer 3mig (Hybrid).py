...
model1error = mean_absolute_error(trainout1, predreg) * maxsaldoreg
print('Обуч. региональный: ', model1error)
...
model2error = mean_absolute_error(trainout2, predinterreg) * maxsaldointerreg
print('Обуч. межрегиональный: ', model2error)
...
model3error = mean_absolute_error(trainout3, predinternat) * maxsaldointernat
print('Обуч. международный: ', model3error)
...
print('Обучение гибрид: ', errortrain)
