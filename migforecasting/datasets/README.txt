citiesdataset 10-21 - полный набор доступных данных
...
inflation0.csv - среднегодовая инфляция (исходные значения)

inflation1.csv - среднегодовая инфляциия (накопительная)
