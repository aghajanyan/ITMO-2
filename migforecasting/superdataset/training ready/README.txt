...
superdataset-20.csv - 9127 examples, отличается от датасета 10 тем, что убраны все мун. образования с населением больше 100 тыс.
...
superdataset-31.csv - 1194 examples, отличается от датасета 13 тем, что убраны все мун. образования с населением меньше 100 тыс.
